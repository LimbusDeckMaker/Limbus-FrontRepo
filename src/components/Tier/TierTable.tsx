...
const TierTable = () => {
  ...
  // S+: 100 약상, 72 쥐싱, 102 선장마엘, 61 디로쟈, 118 마히스, 116 멀파우, 98 넬슈
  const S = [100, 72, 102, 61, 118, 116, 98];

  // S: 122 츠이스, 27 퀴히스, 75 섕싱,121 제로쟈 85 디루, 23 r히스, 94 치티스, 96 퐁그렉
  const A = [122, 27, 75, 121, 85, 23, 94, 96];

  // A: 114 디뫼, 32 k루, 20 갈그렉, 30 콩루
  const B = [114, 32, 20, 30];
