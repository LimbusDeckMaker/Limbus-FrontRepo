...
const gradeImg = [
  "/assets/common/1성.png",
  "/assets/common/2성.png",
  "/assets/common/3성.png",
];
const statusImg = [
  ...
  const renderCollapseContent = () => {
    return (
      <div className="flex flex-col items-center pb-4">
        <Typography
          variant="small"
          className="p-1 md:text-xs flex"
          placeholder={status.life}
        >
